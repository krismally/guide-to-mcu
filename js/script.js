...
function randomChar() {
    // array storing marvel char id's
    const chars = [30, 489, 313, 346, 414, 655, 659, 470, 226, 620, 566, 579, 587, 107, 149, 157, 379, 714];
    // randomize index selected and interpolate onto API link to display char card
...
function render(data) {
    // if char id is incorrect character when searching thor, change result array element to correct thor
